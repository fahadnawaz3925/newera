...
Include:
1. A hook line that creates curiosity or encourages re-watching (e.g., "Turn your sound UP for this 🎧✨", "Wait for the shine at the end... 👞", "That scratchy sound at 0:05... 💆‍♂️").
...
4. A balanced matrix of 6-8 viral hashtags (mix of macro & micro: #ASMR #ShoeShine #LeatherRestoration #Satisfying #ShoeCare #OddlySatisfying #ASMRSounds #buffedboujee).
...
Include:
1. An inspiring title/hook with emoji that grabs attention immediately (e.g. "Save this for when your heart feels heavy 🤲✨", "A reminder you needed to hear today 🕊️", "Pause and listen to this verse 📖").
...
4. A balanced matrix of 6-8 viral hashtags (mix of macro & micro: #IslamicReminders #Quran #Sunnah #Deen #Hadith #Allah #Islam #DeenOverDunya #faithcanvas38).
Keep text clean, respectful, and beautiful. Do NOT use markdown code blocks or header symbols (like ###).`;
  ...
  if (targetAccount === 'account2') {
    ...
    const titleLine = videoTitleClean ? `✨ ${videoTitleClean}` : `A Reminder You Needed To Hear Today 🕊️✨`;
